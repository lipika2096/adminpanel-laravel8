        ...
        <div class="col-span-12 lg:col-span-8 xl:col-span-6 mt-2">
            ...
            <div class="report-box-2 intro-y mt-12 sm:mt-5">
                <div class="box sm:flex">
                    <div class="px-12 py-12 flex flex-col flex-1">
                        <form method="post" action="">
                            ...
                            <br>
                            <div> 
                                <label for="vertical-form-1" class="form-label">Select SubCategory name</label> <select id="subcategory_name" name="subcategory_name" required="" class="form-control">
