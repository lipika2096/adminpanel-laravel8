            ...
            <div class="report-box-2 intro-y mt-12 sm:mt-5">
                <div class="box sm:flex">
                    <div class="px-8 py-12 flex flex-col flex-1">
                        ...
                        <div> <label for="vertical-form-1" class="form-label">Add Category name</label> <input id="category_name" name="category_name" value="microscopes" type="text" required="" class="form-control" placeholder="Add category"> </div>
